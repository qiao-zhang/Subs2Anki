        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="space-y-4 border-b border-slate-800 pb-6">
            ...
            <div className="text-xs text-slate-500">
              Need help with AnkiConnect? <a href="https://foosoft.net/projects/anki-connect/" target="_blank" rel="noreferrer"
          ...
          <div className="space-y-4 border-b border-slate-800 pb-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-slate-500">Automatically delete cards after successful sync to Anki</p>
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2 items-center">
                <input
                  ...
                  className="w-24 bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-white focus:ring-2 focus:ring-indigo-500 outline-none transition text-sm"
                />
                <span className="text-sm text-slate-400">cards (max 50)</span>
                {!isValidLimit && (
                  <span className="text-xs text-red-400">Value must be between 1 and 50</span>
                )}
              </div>
