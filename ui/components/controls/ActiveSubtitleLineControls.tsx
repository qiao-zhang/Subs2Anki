...
import {Video as VideoIcon, Play, Repeat, Download} from 'lucide-react';
...
const ActiveSubtitleLineControls: React.FC<ActiveSubtitleLineControlsProps> = ({
  ...
  return (
    <div className="flex items-center gap-4 w-full justify-center">
      {/* Video Selector */}
      <label
        className="flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 rounded-lg cursor-pointer transition text-sm font-medium text-slate-300 border border-slate-700">
        <VideoIcon size={16}/>
